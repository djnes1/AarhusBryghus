...
public class Tab_Salg extends GridPane {
    ...
    public Tab_Salg(TabPane tabPane, Tab tab) {
        ...
        this.makeEditable();
        VBox vBox = new VBox();
        vBox.getChildren().addAll(txfPrisKr, spinner, btnTilføjTilKurv, btnIndkoebskurv);
